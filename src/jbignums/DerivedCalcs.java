...
class BasicCalculatorWithPow extends BasicCalculator
{
    ...
    @Override
    public void setOperation(String opcode, boolean throwExcIfBad)
    {
...
class ThreeNumberCalculator extends BasicCalculator
{
    ...
    public void setOperation2(String opcode)
    {
        setOperation2(opcode, true);
    }
    public void setOperation2(String opcode, boolean throwExcIfBad)
    {
